...
router.post("/payments/payu", async (req, res) => {
  try {
    ...
    const paymentData = {
      ...
      surl: `https://api.gecestays.com/admin/bookings/success/verify/${txnid}`, // ✅ backend route
      furl: `https://api.gecestays.com/admin/bookings/failed/verify/${txnid}`,  // ✅ backend route
      hash,
      currency: "INR",
